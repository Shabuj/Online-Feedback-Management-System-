      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
			...
			<?php 
			$q=mysqli_query($conn,"select image from user where name='".$_SESSION['user']."'");
			...
			?>
			 ...
			 <li><a href="index.php?page=student_auth"><span class="glyphicon glyphicon-user"></span> Student Authentication </a></li>
