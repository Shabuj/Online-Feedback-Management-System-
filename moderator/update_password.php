...
$sql=mysqli_query($conn,"select * from moderator where password='$op' and name='".$_SESSION['moderator_login']."'");
...
if($r==true)
{
	...
	if($np==$cp)
	{
	$sql=mysqli_query($conn,"update moderator set password='$np' where name='".$_SESSION['moderator_login']."'");
