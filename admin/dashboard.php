    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="dashboard.php"> Feedback Management System</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                       ...
                       <li>
                            <a href="#"><i class="fa fa-user fa-fw"></i>Moderator<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="dashboard.php?info=add_moderator"><i class="fa fa-plus fa-fw"></i> Add Moderator</a>
                                </li>
                                 <li>
                                    <a href="dashboard.php?info=show_moderator"><i class="fa fa-eye"></i> Manage Moderator</a>
                                </li>                           
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
						...
						<li>
                         ...
                         <li>
                            <a href="#"><i class="fa fa-user fa-fw"></i>Courses<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="dashboard.php?info=add_courses"><i class="fa fa-plus fa-fw"></i> Add Courses</a>
                                </li>
                                 <li>
                                    <a href="dashboard.php?info=show_courses"><i class="fa fa-eye"></i> Manage Courses</a>
                                </li>                           
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                	...
                	<?php 
								...
								if($info!="")
								{
									...
									elseif($info=="show_faculty")
                                        ...
                                        if($info=="add_moderator")
                                        {
                                            include('add_moderator.php');
                                        }
                                        
                                    elseif($info=="show_moderator")
                                        {
                                            include('show_moderator.php');
                                        }

                                         elseif($info=="edit_moderator")
                                        {
                                            include('edit_moderator.php');
                                        }
									...
									elseif($info=="feedback")
										...
										elseif($info=="select_teacher")
                                        {
                                            include('select_teacher.php');
                                        }       
										elseif($info=="show_course_tea")
                                        {
                                            include('show_course_tea.php');
                                        }   
