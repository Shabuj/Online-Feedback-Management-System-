...
<body>
	...
	<li class="dropdown">
        ...
        <ul class="dropdown-menu">
		  ...
		  <li><a href="index.php?info=faculty_login">Teacher</a></li> 
          <li><a href="admin">Admin</a></li> 
          <li><a href="index.php?info=moderator_login">Moderator</a></li> 
        </ul>
      </li> 
...
<?php 
					...
					if($info!="")
					{
						 ...
						 include('faculty_login.php');
                          ...
                          else if($info=="moderator_login")
                         {
                         include('moderator_login.php');
                         }
    ...
    <header id="myCarousel" class="carousel slide">
        ...
        <div class="carousel-inner">
        	...
        	<div class="item ">
			 ...
			 <div class="item">
                <div class="fill" style="background-image:url('images/10.jpg');"></div>
                <div class="carousel-caption">
			 ...
			 <div class="item active">
                <div class="fill" style="background-image:url('images/9.jpg');"></div>
                <div class="carousel-caption">
...
<!-- slider -->			
    ...
    <div class="container">
        ...
        <div class="row">
			...
			<div class="col-sm-10" style="margin-top:60px;margin-bottom:80px">
				<h2>About  Feedback Management System</h2>
				Feedback management system is developed for both the student and teacher . Here in this project Student can easily give their feedback or review for any subject or teacher. This project is minimizes our time to give feedback.
	...
	<div class="navbar-fixed-bottom nav navbar-inverse text-center" style="padding:15px;height:40px; background:#66CCFF">
		<span style="color:#FFFFFF"> &copy; All rights reserved by 	<a href="http://"#">Feedback Management System </a> </span>
	</div>
    <!-- jQuery -->
